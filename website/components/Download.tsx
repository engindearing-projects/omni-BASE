      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <GlassCard glow="yellow" className="h-full">
              <div className="flex flex-col items-center text-center p-4">
                <svg className="w-20 h-20 text-omni-yellow mb-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-omni-yellow text-black font-bold rounded-full hover:shadow-2xl transition-all duration-300 glow-yellow inline-block"
                >
          ...
          >
            <GlassCard glow="cyan" className="h-full">
              <div className="flex flex-col items-center text-center p-4">
                <svg className="w-20 h-20 text-omni-cyan mb-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-omni-cyan text-black font-bold rounded-full hover:shadow-2xl transition-all duration-300 glow-cyan opacity-50 cursor-not-allowed"
                  disabled
                >
                  Coming Soon
                </motion.button>
          ...
          <GlassCard hover={false}>
            <div className="text-center">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-6 py-3 glass rounded-full font-bold hover:glow-yellow transition-all duration-300"
              >
