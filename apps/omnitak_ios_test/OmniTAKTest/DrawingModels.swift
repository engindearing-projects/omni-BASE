...
struct MarkerDrawing: DrawingObject {
    ...
    init(id: UUID = UUID(), name: String, color: DrawingColor, coordinate: CLLocationCoordinate2D) {
        self.id = id
        self.name = name
        self.color = color
        self.createdAt = Date()
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, color, createdAt, latitude, longitude
    }
...
struct RouteDrawing: DrawingObject {
    let id: UUID
    var name: String
    var color: DrawingColor
    let createdAt: Date
    ...
    init(id: UUID = UUID(), name: String, color: DrawingColor, coordinates: [CLLocationCoordinate2D]) {
        self.id = id
        self.name = name
        self.color = color
        self.createdAt = Date()
    ...
    // Codable conformance
    enum CodingKeys: String, CodingKey {
        case id, name, color, createdAt, points
    }
...
struct CircleDrawing: DrawingObject {
    ...
    init(id: UUID = UUID(), name: String, color: DrawingColor, center: CLLocationCoordinate2D, radius: CLLocationDistance) {
        self.id = id
        self.name = name
        self.color = color
        self.createdAt = Date()
    ...
    // Codable conformance
    enum CodingKeys: String, CodingKey {
        case id, name, color, createdAt, latitude, longitude, radius
    }
